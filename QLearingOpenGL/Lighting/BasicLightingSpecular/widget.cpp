...
//    glDepthRange(1, 0);
    ...
    m_shaderProgram->addShaderFromSourceFile(QOpenGLShader::Vertex, ":/basicllighting/specular.vert");
    m_shaderProgram->addCacheableShaderFromSourceFile(QOpenGLShader::Fragment, ":/basicllighting/specular.frag");
...
//    glClearDepth(1);
    ...
    m_shaderProgram->setUniformValue("u_ViewPos", m_camera->position());
